...
/**
 * Green banner pinned to the bottom of the viewport while debug mode is on.
...
export function DebugExitBanner() {
  ...
  return (
    <button
      ...
      className="fixed inset-x-0 bottom-0 z-[60] flex items-center justify-center gap-2 bg-emerald-500 px-4 py-3 text-center text-sm font-medium text-black"
