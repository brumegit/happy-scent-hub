  ...
  return (
    ...
    >
      <Tag
        ...
        className={`relative flex w-full items-center justify-center gap-3 border glass px-6 py-4 text-sm uppercase tracking-[0.22em] transition-colors duration-500 ${tone}`}
      >
        {state === "pairing" && (
