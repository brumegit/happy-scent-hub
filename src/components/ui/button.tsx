...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-none text-xs font-medium uppercase tracking-[0.18em] cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "border border-foreground text-foreground bg-transparent hover:bg-foreground/5",
        destructive: "border border-destructive text-destructive bg-transparent hover:bg-destructive/10",
        outline:
          "border border-foreground text-foreground bg-transparent hover:bg-foreground/5",
        secondary: "border border-secondary-foreground text-secondary-foreground bg-transparent hover:bg-secondary/40",
