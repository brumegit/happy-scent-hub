...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Brume 24/7" },
      { name: "description", content: "Pair, tune and schedule your Brume smart scent diffuser." },
      { name: "author", content: "Brume" },
      { property: "og:title", content: "Brume 24/7" },
      { property: "og:description", content: "Pair, tune and schedule your Brume smart scent diffuser." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500;600&family=Jost:wght@300;400;500;600&display=swap",
      },
